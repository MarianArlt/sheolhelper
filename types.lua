...
return {
    ...
    ['Lizard']   = {'Blunt',    'Eft','Kurmajara','Lizard','Raptor','Salamandra'},
    ['Plantoid'] = {'Magic',    'Ameretat','Cynara','Damysus','Dione','Eurytus','Flytrap','Funguar','Goobbue','Korrigan','Maverick Maude','Morbol','Physis','Ptelea','Sabotender','Sapling','Treant'},
    ...
    ['Antica']   = {'Blunt',    'Apollinaris VII-II','Cleaver','Culler','Errant','Magister','Man','Soldier','Swiftcaster','Warden'},
